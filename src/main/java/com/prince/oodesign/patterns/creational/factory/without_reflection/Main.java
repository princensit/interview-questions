...
public class Main {
    ...
    static {
        try {
            Class.forName("com.oodesign.patterns.creational.factory.without_reflection.ProductA");
            Class.forName("com.oodesign.patterns.creational.factory.without_reflection.ProductB");
